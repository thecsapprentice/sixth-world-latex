...
\put( 1cm,4.7cm){ \oswaldfont\fontsize{8pt}{1em}\selectfont\bfseries Sluggish}
\put( 1cm,4.1cm){ \oswaldfont\fontsize{16pt}{1em}\selectfont\bfseries Awareness }
\put( 0cm, 3cm){\usebox{\statBox}}
\put( 1cm,3.7cm){ \oswaldfont\fontsize{8pt}{1em}\selectfont\bfseries Shaky}
\put( 1cm,3.1cm){ \oswaldfont\fontsize{16pt}{1em}\selectfont\bfseries Combat }
\put( 0cm,2cm){\usebox{\statBox}}
\put( 1cm,2.7cm){ \oswaldfont\fontsize{8pt}{1em}\selectfont\bfseries Fragile}
\put( 1cm,2.1cm){ \oswaldfont\fontsize{16pt}{1em}\selectfont\bfseries Stamina }
\put( 0cm,1cm){\usebox{\statBox}}
\put( 1cm,1.7cm){ \oswaldfont\fontsize{8pt}{1em}\selectfont\bfseries Dazed}
\put( 1cm,1.1cm){ \oswaldfont\fontsize{16pt}{1em}\selectfont\bfseries Craft }
\put( 0cm,0cm){\usebox{\statBox}}
\put( 1cm,.7cm){ \oswaldfont\fontsize{8pt}{1em}\selectfont\bfseries Disfigured}
\put( 1cm,0.1cm){ \oswaldfont\fontsize{16pt}{1em}\selectfont\bfseries Presence }
\put( 3cm,4cm){\usebox{\statBoxInf}}
\put( 4cm,4.7cm){ \oswaldfont\fontsize{8pt}{1em}\selectfont\bfseries Dulled}
\put( 4cm,4.1cm){ \oswaldfont\fontsize{16pt}{1em}\selectfont\bfseries Edge }
\put( 3cm,3cm){\usebox{\statBoxInf}}
\put( 4cm,3.7cm){ \oswaldfont\fontsize{8pt}{1em}\selectfont\bfseries Faded}
\put( 4cm,3.1cm){ \oswaldfont\fontsize{16pt}{1em}\selectfont\bfseries Essence }
